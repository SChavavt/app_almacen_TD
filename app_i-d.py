          ...
          try {
            ...
            const safeReload = () => {
              try {
                ...
                const qpUser = url.searchParams.get('usuario') || '';
                const qpTab = url.searchParams.get('tab') || '';
                if (qpUser) url.searchParams.set('usuario', qpUser);
                if (qpTab) url.searchParams.set('tab', qpTab);
            ...
            setTimeout(safeReload, SOFT_RELOAD_MS);
