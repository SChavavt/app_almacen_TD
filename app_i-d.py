...
if selected_tab_key == "dashboard":
    ...
    with st.expander("🧾 Facturas faltantes por enviar", expanded=False):
        st.caption(
            "Aquí se publica la última carga de facturas pendientes por enviar. "
            "Solo SCHAVA y ALEJANDRO38 pueden subir/reemplazar el archivo. "
            "Todos los demás usuarios solo pueden consultar y descargar."
        )
        ...
        if can_upload_facturas:
            ...
            if uploaded_facturas is not None:
                ...
                if parse_error:
                    ...
                    if st.button(
                        "💾 Reemplazar hoja Facturas_Faltantes con este archivo",
                        key="dashboard_facturas_faltantes_save_btn",
            ...
            st.info("Solo SCHAVA y ALEJANDRO38 pueden subir/reemplazar el archivo en esta sección.")
