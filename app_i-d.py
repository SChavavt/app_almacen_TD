    ...
    if not frames:
        ...
        if df_rep.empty:
            ...
            if total == 0:
                ...
                st.caption("Resumen enfocado a surtidores con filtros aplicados (máximo 6 filas).")
                if resumen_surtidores.empty:
                    st.info("No hay surtidores asignados para el filtro actual; la lista 1 está vacía.")
                else:
