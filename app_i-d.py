...
def render_auto_list(
    ...
    row_height_px = 56 if is_pantalla_l_view else 38
    ...
    compact_title_size = "1.2rem" if is_pantalla_l_view else "1.01rem"
    compact_sub_size = "0.94rem" if is_pantalla_l_view else "0.72rem"
    compact_head_size = "0.92rem" if is_pantalla_l_view else "0.67rem"
    compact_td_size = "1.08rem" if is_pantalla_l_view else "0.78rem"
    compact_n_size = "1.15rem" if is_pantalla_l_view else "0.77rem"
    compact_surtidor_size = "1.04rem" if is_pantalla_l_view else "0.75rem"
    compact_status_size = "0.98rem" if is_pantalla_l_view else "0.68rem"
    compact_tag_size = "0.95rem" if is_pantalla_l_view else "0.66rem"
