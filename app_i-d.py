...
if selected_tab_key == "surtidores":
    ...
    with st.form("surtidor_assignment_form"):
        selected_surtidor_nombre = st.selectbox(
            "**Surtidor seleccionado**",
            options=[""] + surtidores_predefinidos,
            format_func=lambda x: "Selecciona un surtidor" if x == "" else x,
        )
        ...
        submit_assignment = st.form_submit_button("✅ Asignar surtidor", use_container_width=True)
