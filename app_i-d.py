...
def aggregate_temporal_view(
    ...
    actual = (
        actual_range.groupby(pd.Grouper(key="Fecha", freq=freq), as_index=False)[["Monto", "Pedidos"]]
        .sum()
        .sort_values("Fecha")
    )
    ...
    prev = (
        prev_range.groupby(pd.Grouper(key="Fecha", freq=freq), as_index=False)[["Monto", "Pedidos"]]
        .sum()
        .sort_values("Fecha")
    )
