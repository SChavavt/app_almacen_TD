        ...
        with main_tabs[8]:  # 🗺️ Ruteo
            ...
            if pedidos_locales.empty:
                ...
                st.markdown(
                    """
                    <style>
                    /* Colores diferenciados para prioridades en tab Ruteo */
                    div[data-testid="stCheckbox"] label:has(input[id^="sinai_pri_"]) {
                        background: rgba(245, 193, 67, 0.20);
                        border-radius: 10px;
                        padding: 4px 10px;
                    }
                    div[data-testid="stCheckbox"] label:has(input[id^="sinai_pri_max_"]) {
