...
def escribir_en_reporte_guias(cliente: Any, vendedor: Any, tipo_envio: Any) -> bool:
    ...
    _debug_reporte_guias_log(f"Detectó Foráneo en Tipo_Envio='{tipo_envio_str}'.")
    ...
    try:
        ...
        _debug_reporte_guias_log(
            f"Fila elegida={fila_destino}; escrito Cliente='{cliente_str}' y Vendedor='{vendedor_recortado}'."
        )
        return True
