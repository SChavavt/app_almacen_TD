    ...
    if clientes_mes.empty:
        ...
        with st.form("ger_cob_form", clear_on_submit=False):
            ...
            if not com_df.empty:
                ...
                if not existentes.empty:
                    ...
                    try:
                        ...
                        fecha_pago_existente = None if pd.isna(fecha_tmp) else fecha_tmp.date()
                    except Exception:
                        fecha_pago_existente = None
            ...
            if st.session_state.get("ger_cob_prefill_ctx") != prefill_ctx:
                ...
                st.session_state["ger_cob_fecha_pago"] = fecha_pago_existente or date.today()
