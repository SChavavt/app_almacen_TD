...
def safe_update_by_id(nombre_hoja: str, id_col: str, id_value: str, updates: dict):
    ...
    for k, v in updates.items():
        ...
        requests.append({"range": a1, "values": [[v]]})
...
with tabs[3]:
    ...
    with sub[2]:
        ...
        opciones = df_tareas_view["_id"].tolist()
        ...
        if tarea_sel:
            row_sel = df_tareas_view[df_tareas_view["_id"] == tarea_sel].iloc[0]
            estatus_actual = str(row_sel.get("_estatus", "")).strip()
