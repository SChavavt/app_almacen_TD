...
def _resolve_alejandro_file_id(file_id: str) -> tuple[str, dict]:
    ...
    try:
        ...
        if "quotaExceeded" in str(e) or "Drive storage quota" in str(e):
            # Sin cuota en Drive: fallback al spreadsheet principal ya existente.
    ...
    if mime == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet":
        try:
            ...
            # Fallback por quota/permisos: usar spreadsheet principal existente.
    ...
    with sub[5]:
        ...
        if st.button("Ejecutar diagnóstico", key="diag_alejandro_doc"):
            ...
            if diag.get("quota_fallback"):
                st.success(
                    "Drive está en quota/permisos restringidos; se activó fallback al spreadsheet principal para no bloquear operación."
                )
