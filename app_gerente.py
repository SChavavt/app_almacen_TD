...
def _admintotal_factura_a_fila(factura: dict) -> dict:
    return {
        "Vendedor": _admintotal_primer_valor(factura, ["vendedor", "vendedor_nombre", "creado_por", "usuario", "usuario_nombre"]),
        ...
        "Fecha": _admintotal_primer_valor(factura, ["fecha", "fecha_creacion", "fecha_timbrado"]),
    }
    ...
    with tab_map["organizador"]:
        ...
        with sub_map["check_facturas"]:
            ...
            st.caption(
                ...
                f"y consulta AdminTotal del {fecha_desde_auto:%Y-%m-%d} al {fecha_hasta_auto:%Y-%m-%d}."
            )
                    ...
                    with st.spinner("Consultando facturas de AdminTotal y ejecutando check..."):
                        ...
                        if not resultado_admintotal.get("success"):
                            ...
                            resultado_check_auto = analizar_facturas_check_desde_df(
                                df_admintotal,
                                ventana_horas=ADMINTOTAL_CHECK_FACTURAS_DIAS * 24,
                            )
                            firma_auto = (
