            ...
            if saldos_df.empty:
                ...
                if not venc_df.empty:
                    ...
                    if not agenda_df.empty:
                        agenda_df["Etiqueta_Cliente"] = agenda_df["Codigo"]
                        ...
                        orden_codigos = (
                            agenda_df.groupby("Etiqueta_Cliente", as_index=False)["Saldo_Vence"].sum()
                            .sort_values("Saldo_Vence", ascending=False)["Etiqueta_Cliente"].tolist()
                        )
                        ...
                        fig_agenda.update_layout(margin=dict(l=10, r=10, t=10, b=10), coloraxis_colorbar_title="Saldo", yaxis_categoryorder="array", yaxis_categoryarray=orden_codigos, yaxis_showticklabels=False)
