            ...
            if idx_caso is None or idx_caso not in df_casos_filtrado.index:
                ...
                if usar_nuevo_sistema:
                    ...
                    frases_base = [
                        ...
                        "Ya quedó",
                        "Ya se envió",
                        "Ya se realizó devolución",
                        "Ya retornaron el material",
                        "Ya devolvió",
                        "Ya se cambió / pasó a bodega",
                        "Ya pagó la diferencia",
                    ...
                    frase_base_sel = st.selectbox(
                        ...
                        [""] + frases_base,
                        key=base_key,
                        help="Selecciona una frase corta predefinida para acelerar la captura.",
                    )
